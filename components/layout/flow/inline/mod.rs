...
use style::values::computed::{BaselineShift, OverflowWrap};
...
impl InlineFormattingContext {
    ...
    fn new_with_builder(
        ...
        let shared_inline_styles = builder
            ...
            .clone();
        let (word_break, line_break, lang, overflow_wrap) = {
            ...
            (
                ...
                if text_style.word_break == WordBreak::BreakWord {
        ...
        let mut new_linebreaker = LineBreaker::new(text_content.as_str(), options, overflow_wrap);
